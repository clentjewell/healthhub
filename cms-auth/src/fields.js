...
export const FIELD_META = {
  ...
  practitioners: {
    ...
    labels: {
      ...
      classPage: 'Class page link', feeGroups: 'Fees & class passes',
    },
    hints: {
      role: 'e.g. Hatha & Yin Yoga Teacher.',
      service: 'The matching service slug, e.g. hatha-yin-yoga.',
      order: 'Lower numbers appear first.',
      classPage: 'Link to this teacher’s class page for its times & fees, e.g. /event/hatha-yin-yoga#fees. Leave blank for practitioners with no class.',
      feeGroups: 'Advanced: a list of fee tables. Only used when there is no class page (e.g. one-to-one consults). Keep the layout/indentation.',
    },
  },
  ...
  events: {
    ...
    hints: {
      ...
      feeGroups: 'Advanced: the times & fees shown in a box on this page. Keep the layout/indentation.',
